...
""";
    ...
    private IReadOnlyList<McpToolDefinition> CreateTools()
    {
        ...
        [
            ...
            new McpToolDefinition(McpToolNames.CheckDuplicate, "Check if content already exists in the palace before filing.", Schema(new[] { "content" }, new SchemaProperty("content", "string", "Content to check"), new SchemaProperty("threshold", "number", "Similarity threshold 0-1 (default 0.9)")), ToolCheckDuplicateAsync),
